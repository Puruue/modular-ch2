...
public class NameInput : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Debug.Log($"[NameInput] Awake -> CurrentName='{_playerName}' (resetOnOpen={alwaysResetToDefaultOnOpen}, pushOnAwake={pushToSaveGameManagerOnAwake})");
    }
    ...
    /// <summary>
    /// ✅ No side effects: returns the final name you SHOULD use for checks.
    /// </summary>
    ...
    /// <summary>
    /// ✅ No side effects: updates internal name + UI but does NOT save/persist or invoke Done events.
    /// </summary>
    ...
    private void PersistNameToPrefsAndManager()
    {
        ...
        // ✅ only push if this NameInput is meant to control the profile/session
